...
if __name__ == "__main__":
    ...
    出租方（甲方）：张三，身份证号：110101199001011234
    承租方（乙方）：李四，身份证号：110101199202022345
    
    一、房屋基本信息
    房屋地址：北京市朝阳区建国路88号，面积：80平方米，户型：两室一厅
    
    二、租赁期限
    租赁期限自2024年3月1日起至2025年2月28日止，共计12个月。
    
    三、租金及支付方式
    月租金：5000元整，支付方式：押一付三
    押金：5000元整
    
    四、房屋用途
    乙方租赁该房屋仅作为居住使用，不得用于其他用途。
    
    五、维修责任
    房屋自然损坏由甲方负责维修，人为损坏由乙方负责维修。
    
    六、违约责任
    任何一方违反本合同约定，应向对方支付一个月租金作为违约金。
    
    七、其他约定
    1. 乙方未经甲方同意不得转租房屋。
    2. 租赁期满，乙方应将房屋恢复原状并交还给甲方。
    3. 本合同一式两份，甲乙双方各执一份。
